...
export class OperatorComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.operatorService
      ...
      .subscribe((res: HttpResponse<IOperator[]>) => this.paginateOperators(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IOperator) {
    return item.id;
  }
  ...
  protected paginateOperators(data: IOperator[], headers: HttpHeaders) {
