...
export class AdministratorComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.administratorService
      ...
      .subscribe((res: HttpResponse<IAdministrator[]>) => this.paginateAdministrators(res.body, res.headers));
  }
  ...
  registerChangeInAdministrators() {
    this.eventSubscriber = this.eventManager.subscribe('administratorListModification', () => this.loadAll());
  }

  delete(administrator: IAdministrator) {
  ...
  protected paginateAdministrators(data: IAdministrator[], headers: HttpHeaders) {
