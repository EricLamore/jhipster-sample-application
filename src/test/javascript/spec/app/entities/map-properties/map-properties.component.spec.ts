...
import { MapPropertiesComponent } from 'app/entities/map-properties/map-properties.component';
...
describe('Component Tests', () => {
  describe('MapProperties Management Component', () => {
    let comp: MapPropertiesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MapPropertiesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mapProperties[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
