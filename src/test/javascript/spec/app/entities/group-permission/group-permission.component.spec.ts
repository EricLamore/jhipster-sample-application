...
import { GroupPermissionComponent } from 'app/entities/group-permission/group-permission.component';
...
describe('Component Tests', () => {
  describe('GroupPermission Management Component', () => {
    let comp: GroupPermissionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GroupPermissionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.groupPermissions[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
