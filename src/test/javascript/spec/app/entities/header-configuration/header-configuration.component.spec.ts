...
import { HeaderConfigurationComponent } from 'app/entities/header-configuration/header-configuration.component';
...
describe('Component Tests', () => {
  describe('HeaderConfiguration Management Component', () => {
    let comp: HeaderConfigurationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HeaderConfigurationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new HeaderConfiguration('123')],
            headers
          })
        )
      );
      ...
      expect(comp.headerConfigurations[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
