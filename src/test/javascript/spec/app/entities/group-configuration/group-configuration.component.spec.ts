...
import { GroupConfigurationComponent } from 'app/entities/group-configuration/group-configuration.component';
...
describe('Component Tests', () => {
  describe('GroupConfiguration Management Component', () => {
    let comp: GroupConfigurationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GroupConfigurationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new GroupConfiguration('123')],
            headers
          })
        )
      );
      ...
      expect(comp.groupConfigurations[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
